...
export const PATTERNS = [
  { ev: "HACKMIT 2024", pl: "1st Place", n: "FoodBridge", d: "Real-time food rescue connecting restaurants with shelters via geolocation and route optimization.", dom: "Food Systems", stack: ["Next.js", "Supabase", "Mapbox", "Turf.js", "Twilio", "Vercel"], sdgs: ["SDG 2", "SDG 11", "SDG 17"], href: "https://devpost.com/search?query=FoodBridge+hackmit" },
  { ev: "TREEHACKS 2024", pl: "1st Place", n: "CarbonLens", d: "Browser extension estimating product carbon footprints in real-time while shopping online.", dom: "Climate", stack: ["React", "Python FastAPI", "OpenAI API", "MongoDB", "Chrome Extensions"], sdgs: ["SDG 12", "SDG 13"], href: "https://devpost.com/search?query=CarbonLens+treehacks" },
  { ev: "PENNAPPS 2024", pl: "2nd Place", n: "MedBridge", d: "Multilingual health intake system for underserved clinics with real-time translation and summaries.", dom: "Health Equity", stack: ["Next.js", "Anthropic Claude", "Supabase", "Vercel AI SDK", "React Hook Form"], sdgs: ["SDG 3", "SDG 10"], href: "https://devpost.com/search?query=MedBridge+pennapps" },
  { ev: "CALTECH 2025", pl: "1st Place", n: "GridWatch", d: "Community energy monitoring with low-cost sensors, anomaly detection, and public dashboards.", dom: "Energy", stack: ["React", "Supabase Realtime", "Python", "Recharts", "Vercel"], sdgs: ["SDG 7", "SDG 11"], href: "https://devpost.com/search?query=GridWatch+caltech" },
  { ev: "NWPLUS 2025", pl: "1st Place", n: "LexPath", d: "Plain-language legal document explainer for immigrants navigating complex paperwork.", dom: "Civic", stack: ["Next.js", "OpenAI GPT-4", "Supabase", "LangChain.js", "Framer Motion"], sdgs: ["SDG 16", "SDG 10"], href: "https://devpost.com/search?query=LexPath+nwplus" },
  { ev: "HACKHARVARD 2024", pl: "1st Place", n: "SkillBridge", d: "AI-powered skills gap analyzer mapping workers' skills to local jobs and micro-certifications.", dom: "Economic", stack: ["Next.js", "Vercel AI SDK", "Supabase", "Drizzle ORM", "TanStack Table"], sdgs: ["SDG 8", "SDG 4"], href: "https://devpost.com/search?query=SkillBridge+hackharvard" },
]
